...
def get_dealerships(request):
    if request.method == "GET":
        context = {}
        url = "https://14b3146c.us-south.apigw.appdomain.cloud/api/dealerships"
...
def get_dealer_details(request, id):
    if request.method == "GET":
        context = {}
        dealer_url = "https://14b3146c.us-south.apigw.appdomain.cloud/api/dealership_state/dealership_state"
