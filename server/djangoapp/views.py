...
from .restapis import get_dealerships, get_dealer_details, get_dealer_reviews, post_request 
...
def get_dealer_details(request, id):
    if request.method == "GET":
        ...
        reviews = get_allReviews_byID(review_url, id=id)
        print(reviews)
...
def add_review(request, id):
    ...
    if request.method == 'GET':
        ...
        if request.user.is_authenticated:
            ...
            review_post_url = "https://2d6871f8.us-south.apigw.appdomain.cloud/api/post_review"
