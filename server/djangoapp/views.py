...
from .restapis import get_dealerships_from_cf, get_reviews_from_cf, get_post_reviews_from_cf, get_request, post_request
...
def get_dealerships(request, id):
    if request.method == "GET":
        ...
        review_url = "https://7eb5862d.us-south.apigw.appdomain.cloud/api/reviews"
